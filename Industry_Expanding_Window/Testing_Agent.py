...
# Whole sample : rolling window training + testing, we will do chunk training + need exploration too which is decaying over time.
parser.add_argument('--whole_sample', type=str2bool, nargs='?', default=True)
